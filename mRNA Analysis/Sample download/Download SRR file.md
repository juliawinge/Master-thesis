...
Click on the menu and select **"All files"** to see the TSV files, then press on the TSV file of interest, followed by **"Import"**.
...
Save the file in **TSV** or **TXT** format in a designated folder **"/your_directory/hot_spot_analysis"**, name it by the gene name followed by tissue/ histology type.
