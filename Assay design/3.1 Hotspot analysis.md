...
*This step identifies recurrent mutation sites, referred to here as hotspots, from the simplified COSMIC sample sheets created according to the previous step. A hotspot is defined as the same cDNA position occurring in at least three unique patients.* <br>
