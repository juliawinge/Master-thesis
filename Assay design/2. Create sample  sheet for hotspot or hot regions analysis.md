...
Open a new Excel document/ new page.  <br>

Go to **Data** in the top menu, and click **"From text/CSV"**. <br>
...
In the file selection window, open the file type menu and select **All files** to make the `.tsv` files visible.  <br>

Select the TSV file of interest, and click **Import**. <br>
<img width="955" height="597" alt="image" src="https://github.com/user-attachments/assets/6c7ce6ec-73e5-4253-847b-0e982a857e85" />

## 3. Import the file
 Use the import settings shown below, and click **Read file**. <br>
...
Create a new Excel file/ page. <br>
...
These column names are required as input for the downstream scripts.  <br>
...
Save the file in `.tsv` or `.txt` format in the following folder: <br>
```
/your_directory/hot_spot_region_analysis
```
<br>

Name the file using the gene name followed by tissue or histology type. <br>
