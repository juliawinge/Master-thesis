...
Click the result link to open the predicted PCR product.  <br>

If a **fix** option appears, do not click it.  <br>
...
Hover over **View** found in the menu, and select **DNA sequence**. <br>
<img width="1551" height="313" alt="image" src="https://github.com/user-attachments/assets/2f7aea88-f314-4828-a6b1-d6934e501bb2" /> <br>

Set both upstream and downstream sequences to **0** bp.  <br>

Click **Get DNA**. <br>
<img width="1575" height="571" alt="image" src="https://github.com/user-attachments/assets/b9d96367-d44a-4097-84a4-6b8377191f8c" /> <br>

Copy the DNA sequence.  <br>
...
https://en.vectorbuilder.com/tool/gc-content-calculator.html <br>

Paste the copied DNA sequence into the sequence box.  <br>
